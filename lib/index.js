...
POP3Client.prototype.user = function(username) {
    ...
    if (!self.beginCommand(100)) return false;
...
POP3Client.prototype.stat = function() {
    ...
    if (!self.beginCommand(1000)) return false;
...
POP3Client.prototype.list = function(msgNo) {
    ...
    if (!self.beginCommand(1000, multi)) return false;
...
POP3Client.prototype.retr = function(msgNo) {
    ...
    if (!self.beginCommand(1000, !msgNo)) return false;
...
POP3Client.prototype.quit = function() {
    ...
    if (!self.beginCommand([100, 1000], false, 3 * self.state)) return false;
...
POP3Client.prototype.top = function(msgNo, lines) {
    ...
    if (!self.beginCommand(1000, true)) return false;
...
POP3Client.prototype.apop = function(name, secret) {
    ...
    if (!self.beginCommand(100, false, 200)) return false;
